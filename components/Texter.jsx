...
function Texter() {
  ...
  return (
    <div className=' container my-[120px] '>
      <SlideUpText  className={`relativ text-par  inline-flex overflow-hidden  text-[56px] md:text-[96px]  leading-[1] text-customColor font-custom2`} text={"10 years bringing your worth it stories to life."} fontSize={96} clamp={false}/>
